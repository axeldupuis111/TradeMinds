...
//
// Aucun code d'invitation, aucun formulaire : on entre en s'abonnant avec le
// CODE PROMO du partenaire (le majuscule de son slug), et le rattachement est
// posé par le webhook Stripe. Une seule porte, une seule phrase à dire à son
// audience, et la communauté ne contient que les gens qu'il a réellement
// amenés. Un code d'invitation à saisir a été essayé puis retiré : il faisait
// deux mécaniques à expliquer pour un seul résultat.
