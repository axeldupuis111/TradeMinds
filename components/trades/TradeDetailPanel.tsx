        ...
        <div className={`p-5 space-y-6 transition-opacity duration-150 motion-reduce:transition-none ${isTransitioning ? "opacity-0" : "opacity-100"}`}>
          ...
          <div className="bg-background rounded-lg p-4 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              {/* ⚠️ Zéro n'est pas un prix : voir lib/prix-connu.ts. */}
              ...
              <div><span className="text-muted">{t("trades_col_sl")}:</span> <span className="text-foreground">{prixConnu(trade.sl) != null ? fmtPrice(prixConnu(trade.sl)!) : "—"}</span></div>
              <div><span className="text-muted">{t("trades_col_tp")}:</span> <span className="text-foreground">{prixConnu(trade.tp) ?? "—"}</span></div>
            </div>
          ...
          <div>
            ...
            {screenshotUrl && (
              <div className="mb-2 relative group">
                ...
                <div className="absolute top-2 right-2 flex items-center gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 [@media(hover:none)]:opacity-100 transition-opacity">
                  <button
